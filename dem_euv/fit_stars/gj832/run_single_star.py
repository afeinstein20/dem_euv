...
def generate_gj832_data_npy():
    fname = 'hlsp_muscles_xmm_epic_gj832_multi_v22_component-spec.fits'
    ...
    plt.show()
    np.save('gj832_spectrum_data.npy',
            [xray_wave, xray_bins,
             xray_flux, xray_err])
    return 'gj832_spectrum_data.npy'
...
if __name__ == '__main__':
    ...
    star_rad = 0.499 * u.R_sun
    star_name_root = 'gj832'
    abundance = -0.31
    ...
    if os.path.isfile('gj832_spectrum_data.npy'):
        data_npy_file = 'gj832_spectrum_data.npy'
    else:
        data_npy_file = generate_gj832_data_npy()
    line_table_file = 'gj832_linetable.ascii'
