...
def generate_gj581_data_npy():
    fname = 'hlsp_muscles_cxo_acis_gj581_na_v22_component-spec.fits'
    ...
    plt.show()
    np.save('gj581_spectrum_data.npy',
            [xray_wave, xray_bins,
             xray_flux, xray_err])
    return 'gj581_spectrum_data.npy'


if __name__ == '__main__':
    temp = np.logspace(4, 8, 2000)
    log_temp = np.log10(temp)
    star_dist = 6.2992 * u.pc
    star_rad = 0.31 * u.R_sun
    star_name_root = 'gj581'
    abundance = 0.0
    ...
    if os.path.isfile('gj581_spectrum_data.npy'):
        data_npy_file = 'gj581_spectrum_data.npy'
    else:
        data_npy_file = generate_gj581_data_npy()
    line_table_file = 'gj581_linetable.ascii'
