...
def generate_gj876_data_npy():
    fname = 'hlsp_muscles_cxo_acis_gj876_na_v22_component-spec.fits'
    ...
    plt.show()
    np.save('gj876_spectrum_data.npy',
            [xray_wave, xray_bins,
             xray_flux, xray_err])
    return 'gj876_spectrum_data.npy'


if __name__ == '__main__':
    temp = np.logspace(4, 8, 2000)
    log_temp = np.log10(temp)
    star_dist = 4.6758 * u.pc
    star_rad = 0.372 * u.R_sun
    star_name_root = 'gj876'
    abundance = 0.2
    ...
    if os.path.isfile('gj876_spectrum_data.npy'):
        data_npy_file = 'gj876_spectrum_data.npy'
    else:
        data_npy_file = generate_gj876_data_npy()
    line_table_file = 'gj876_linetable.ascii'
