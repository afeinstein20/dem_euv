...
def generate_gj176_data_npy():
    fname = 'hlsp_muscles_cxo_acis_gj176_na_v22_component-spec.fits'
    ...
    plt.show()
    np.save('gj176_spectrum_data.npy',
            [xray_wave, xray_bins,
             xray_flux, xray_err])
    return 'gj176_spectrum_data.npy'


if __name__ == '__main__':
    temp = np.logspace(4, 8, 2000)
    log_temp = np.log10(temp)
    star_dist = 4.965 * u.pc
    star_rad = 0.474 * u.R_sun
    star_name_root = 'gj176'
    abundance = -0.1
    ...
    if os.path.isfile('gj176_spectrum_data.npy'):
        data_npy_file = 'gj176_spectrum_data.npy'
    else:
        data_npy_file = generate_gj176_data_npy()
    line_table_file = 'gj176_linetable.ascii'
